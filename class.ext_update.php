...
class ext_update {
	...
	public function main()	{
		...
		$databaseUpdateUtility->doUpdate('static_info_tables_es');

		$content.= '<p>' . \TYPO3\CMS\Extbase\Utility\LocalizationUtility::translate('updateLanguageLabels', 'StaticInfoTables') . ' static_info_tables_es.</p>';
		return $content;
	}
