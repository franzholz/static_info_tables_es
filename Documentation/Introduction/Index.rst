...
This extension provides Spanish translations for the country, country subdivision, currency, language and territory records of static_info_tables.
For this purpose, it adds one or two fields to those tables and fills them with Spanish data, if available.
...
.. figure:: /Images/RecordView.png
	...
	Record view of the "Spanish" country record with new field "Short name (ES)" filled with the Spanish translation.
