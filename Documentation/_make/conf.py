# -*- coding: utf-8 -*-
#
# Static Info Tables (es) documentation build configuration file, created by
...
project = u'Static Info Tables (es)'
...
htmlhelp_basename = 'static_info_tables_esdoc'
...
latex_documents = [
    ('Index', 'static_info_tables_es.tex', u'Static Info Tables (es)',
...
pdf_documents = [
    ('Index', 'static_info_tables_es', u'Static Info Tables (es)',
     u'Franz Holzinger'),
]
...
texinfo_documents = [
    ('Index', 'static_info_tables_es', u'Static Info Tables (es)',
     u'Franz Holzinger', 'Static Info Tables (es)', 'One line description of project.',
     'Miscellaneous'),
]
